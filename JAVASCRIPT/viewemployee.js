document.addEventListener('DOMContentLoaded', function () {
    ...
    function populateEmployeeTable(employees) {
        employees.forEach(employee => {
            ...
            row.insertCell(0).innerText = employee.employeeNumber;
            ...
            row.insertCell(4).innerText = employee.officeEmail;
            row.insertCell(5).innerText = employee.mobileNo;
            row.insertCell(6).innerText = employee.workLocation;
            row.insertCell(7).innerText = employee.dateOfJoining;
            row.insertCell(8).innerText = employee.reportsTo;
            ...
            row.insertCell(14).innerText = employee.roleName;
            ...
            row.insertCell(18).innerText = employee.bankAccountNumber;
            row.insertCell(19).innerText = employee.bankIfscCode;
            row.insertCell(20).innerText = employee.company;
            row.insertCell(21).innerText = employee.confirmationDate;
            ...
            row.insertCell(33).innerText = employee.panNumber;
            ...
            row.insertCell(38).innerHTML = shiftTiming; // Insert shift timings
            ...
            `;
            row.insertCell(39).innerHTML = leaveBalance; // Use innerHTML to display multiline text

            // Insert status and UAN number
            row.insertCell(40).innerText = employee.status;
